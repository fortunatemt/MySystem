...
public class createUserStuffInterFace extends javax.swing.JPanel{
	...
	public createUserStuffInterFace(){//增加删除原料
	...
	private void IsGood(){
		...
		String sql1 = "'"+id+"','"+name+"','"+company+"','"+people+"','"+check+"','"+unit+"','"+value+"','"+spec+"','"+color+"','"+place+"','"+date+"','"+text+"'";
		sql ="insert into stuff_in values("+sql1+")";
		USeDB.UpdateDB(sql);
		sql = "insert into stuff_old_record values("+sql1+")";
		USeDB.UpdateDB(sql);
		clean();
